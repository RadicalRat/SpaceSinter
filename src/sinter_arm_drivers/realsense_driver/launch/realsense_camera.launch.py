...
def launch_setup(context, params, param_name_suffix=''):
    ...
    pkg_dir = get_package_share_directory("realsense_driver")

    _config_file = os.path.join(pkg_dir, 'config', 'realsense_color.yaml')
    params_from_file = {} if not os.path.isfile(_config_file) else yaml_to_dict(_config_file)
    ...
    if os.path.isfile(lifecycle_param_file):
